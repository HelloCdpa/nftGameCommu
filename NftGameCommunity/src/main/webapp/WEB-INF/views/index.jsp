            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="/board/boardFindAll">커뮤니티</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="#">NFT</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="#">포인트 샵</a>
                  </li>
                </ul>
 ...
 <div class="container px-4 px-lg-5 " style="margin-top:100px">
  ...
  <div class="row gx-4 gx-lg-5 align-items-center my-5">
      ...
      <div class="col-lg-5">
          ...
          <a class="btn btn-outline-success" href="#!">NFT 구매하러 가기!</a>
      </div>
  </div>
  <!-- Call to Action-->
  <div class="card text-white my-5 py-4 text-center bg-gradient">
  ...
  <div class="row gx-4 gx-lg-5 bg-gradient">
      <div class="col-md-4 mb-5">
          <div class="card h-100">
              ...
              <div class="card-footer text-center"> 귀여운 조디움 강아지! 40000p <a class="btn btn-outline-success btn-sm" href="#!">구매</a></div>
          </div>
      </div>
      <div class="col-md-4 mb-5 bg-gradient">
          <div class="card h-100">
              ...
              <div class="card-footer text-center"> 발칙한 병아리! 20000p <a class="btn btn-outline-success btn-sm" href="#!">구매</a></div>
          </div>
      </div>
      <div class="col-md-4 mb-5 bg-gradient">
          <div class="card h-100">
              ...
              <div class="card-footer text-center"> 발랄한 학생! 30000p <a class="btn btn-outline-success btn-sm" href="#!">구매</a></div>
          </div>
      </div>
  </div>
</div>
